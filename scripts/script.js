...
const profileNameEditField = profileEditPopup.querySelector('.popup__input_type_name');
const profileInfoEditField = profileEditPopup.querySelector('.popup__input_type_personal-info');
...
profileInfoEditField.value = profilePersonalInfo.textContent;
});
...
const profileEditFormHandler = (evt) => {
  ...
  profilePersonalInfo.textContent = profileInfoEditField.value;
...
zoomedImageCloseButton.addEventListener('click', () => closePopup(imageZoomPopup));
